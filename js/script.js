window.addEventListener("load", function () {
    ...
    var load = function () {
        ...
        sprites.background.src = 'images/dungeon.png';

        sprites.enemy = new Image();
        sprites.enemy.src = 'images/enemy.png';

        sprites.goal = new Image();
        sprites.goal.src = 'images/stairs.png';
    };
    ...
    var update = function () {
        ...
        if (checkCollision(player, goal)) {
            ...
            //Change the Background and the Enemy during Level increase

            switch (level) {
                case 2:
                    sprites.enemy.src = 'images/enemy2.png';
                    break;
                case 3:
                    sprites.enemy.src = 'images/enemy3.png';
                    break;
                case 4:
                    sprites.enemy.src = 'images/enemy4.png';
                    break;
                case 5:
                    sprites.enemy.src = 'images/enemy5.png';
                    break;
                case 6:
                    sprites.enemy.src = 'images/enemy6.png';
